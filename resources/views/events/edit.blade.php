        ...
        <form action="{{ route('events.update', $event) }}" method="POST" class="relative px-6 pb-6 flex-auto">
            ...
            <div class="my-4 text-slate-500 text-lg leading-relaxed">
                ...
                <select name="title" id="title" required
                    ...
                    @foreach (Config::get('type.type_name') as $key => $val)
                        <option value="{{ $key }}"
                            {{ old('title', $event->title) == $key ? 'selected' : $key }}>
                            {{ $key }}</option>
                    @endforeach
                </select>
            </div>
            <div class="my-4 text-slate-500 text-lg leading-relaxed">
                ...
                <input type="number" name="guest_count" id="guest_count" placeholder="{{ __('Guest Count') }}"
                    value="{{ old('guest_count', $event->guest_count) }}" required
                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
            </div>
            <div class="my-4 text-slate-500 text-lg leading-relaxed">
                ...
                <input type="number" name="child_count" id="child_count" placeholder="{{ __('Child Count') }}"
                    value="{{ old('child_count', $event->child_count) }}" required
                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
            </div>
            <div class="my-4 text-slate-500 text-lg leading-relaxed">
                ...
                <input type="text" name="seat" id="seat" placeholder="{{ __('Seat') }}"
                    value="{{ old('seat', $event->seat) }}" required
                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
            </div>
            ...
            <div class="my-4 text-slate-500 text-lg leading-relaxed">
                ...
                <input type="text" name="customer_name" id="customer_name" placeholder="{{ __('Customer Name') }}"
                    value="{{ old('customer_name', $event->customer_name) }}" required
                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
            </div>
            <div class="my-4 text-slate-500 text-lg leading-relaxed">
                ...
                <input type="number" name="customer_phone" id="customer_phone"
                    ...
                    value="{{ old('customer_phone', $event->customer_phone) }}" required
                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
            </div>
            <div class="my-4 text-slate-500 text-lg leading-relaxed">
                ...
                <input type="text" name="receptionist_name" id="receptionist_name"
                    ...
                    value="{{ old('receptionist_name', $event->receptionist_name) }}" required
                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
            </div>
            <div class="my-4 text-slate-500 text-lg leading-relaxed">
                ...
                <input type="text" name="final_confirmation" id="final_confirmation"
                    ...
                    value="{{ old('final_confirmation', $event->final_confirmation) }}" required
                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
            </div>
